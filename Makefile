...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ven. oct. 15 15:22:26 2010
# Project:  iscore.pro
# Template: lib
# Command: /usr/bin/qmake -spec /usr/local/Qt4.7/mkspecs/macx-g++ -o Makefile iscore.pro
#############################################################################
...
INCPATH       = -I/usr/local/Qt4.7/mkspecs/macx-g++ -I. -I. -IIncludes -I/usr/local/include/IScore -I/usr/local/include -I/usr/local/include/libxml2 -I/usr/local/include/IScore -I. -IIncludes -I/Library/Frameworks -I/usr/local/include/IScore -I/usr/local/include -I/usr/local/include/libxml2 -I. -IIncludes -IEnginesPrivate -IECOMachine -IECOMachine/PetriNet -IECOMachine/Process -IEditor/CSP -IStoryLine -IEditor/gecode-solver -IEditor
AR            = ar cq
RANLIB        = ranlib -s
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: iscore.pro  /usr/local/Qt4.7/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
		/usr/local/Qt4.7/mkspecs/common/mac.conf \
		/usr/local/Qt4.7/mkspecs/common/mac-g++.conf \
		/usr/local/Qt4.7/mkspecs/qconfig.pri \
		/usr/local/Qt4.7/mkspecs/modules/qt_webkit_version.pri \
		...
		/usr/local/Qt4.7/mkspecs/features/staticlib.prf \
		/usr/local/Qt4.7/mkspecs/features/static.prf
	$(QMAKE) -spec /usr/local/Qt4.7/mkspecs/macx-g++ -o Makefile iscore.pro
...
StoryLine.o: StoryLine/StoryLine.cpp StoryLine/StoryLine.hpp \
		Editor/CSP/CSP.hpp \
		Editor/CSP/XMLInclude.hpp \
		Editor/CSP/XMLConversion.hpp \
		Editor/CSP/InvalidFileFormatException.hpp \
