...
then
	...
	sudo ln -f -s /usr/local/lib/libIscore.so.1.0.0 /usr/local/lib/libIscore.so.1.0
	sudo ln -f -s /usr/local/lib/libIscore.so.1.0.0 /usr/local/lib/libIscore.so.1
	sudo ln -f -s /usr/local/lib/libIscore.so.1.0.0 /usr/local/lib/libIscore.so
	sudo ldconfig
fi
